...
const AboutUs: React.FC = () => {
  ...
  return (
    <section id="about" className="flex flex-col bg-white w-full px-4">
      ...
      {/* First Section */}
      <div
        className="flex flex-col lg:flex-row justify-center items-center gap-10 lg:gap-36 py-20"
        data-aos="fade-up"
      >

        {/* Left Card */}
        <div
          className="flex flex-col items-center gap-4 w-full lg:w-[277.5px] flex-shrink-0"
          data-aos="zoom-in"
        >
        ...
        <div
          className="hidden lg:block h-[214px] w-[1px] bg-[#83A790]"
          data-aos="fade-right"
        />

        {/* Right Content */}
        <div
          className="flex flex-col items-center lg:items-start gap-4 w-full lg:max-w-[348px]"
          data-aos="fade-left"
        >
      ...
      >
        ...
        {/* Text Left */}
        <div
          className="flex flex-col items-center lg:items-start gap-4 w-full max-w-[395px] text-center lg:text-left"
          data-aos="fade-right"
        >
        ...
        <div
          className="hidden lg:flex w-full max-w-[348px]"
          data-aos="zoom-in"
        >
          <Image
