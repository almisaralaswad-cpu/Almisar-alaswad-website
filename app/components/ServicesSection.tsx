...
const ServicesSection: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Left Image */}
      <div
        className="flex justify-center md:justify-start flex-shrink-0 w-[220px] h-[180px] md:w-[433px] md:h-[364px]"
        data-aos="fade-right"
        data-aos-delay="100"
      >
        <Image
      ...
      >
        ...
        {/* Logo */}
        <div
          className="flex justify-center md:justify-start flex-shrink-0 w-[180px] h-[60px] md:w-[394px] md:h-[132px]"
          data-aos="zoom-in"
          data-aos-delay="250"
        >
          <Image
        ...
        {/* Description */}
        <p
          className="text-[#666] font-['Be Vietnam Pro'] text-[11px] md:text-[13px] font-normal leading-[150%] md:leading-[160%] max-w-[90%] md:max-w-none"
          data-aos="fade-up"
          data-aos-delay="300"
        >
          {description}
        ...
        {/* Buttons Section */}
        <div
          className="flex flex-row gap-3 mt-4 md:mt-6"
          data-aos="zoom-in"
          data-aos-delay="400"
        >
          <button className="rounded-[4.5px] bg-[#CF3D31] text-white font-lato text-[13px] md:text-[15px] font-medium px-6 py-[9px] flex items-center justify-center gap-[7.5px] hover:opacity-90 transition-all">
            {intl.formatMessage({ id: "servicesSection.bookNow" })}
          </button>

          <button className="flex items-center justify-center gap-[7.5px] border border-[#666] bg-white text-[#111D15] font-lato text-[13px] md:text-[15px] font-medium px-6 py-[9px] rounded-[4.5px] hover:bg-gray-100 transition-all">
