...
const Services: React.FC = () => {
  ...
  return (
    <section
      id="services"
      className="flex flex-col gap-6 items-center py-16 bg-white"
    >
      <div
        className="flex justify-between items-center w-full max-w-[877.5px] px-4 md:px-0"
        data-aos="fade-right"
      >
      ...
      <div
        className="w-full max-w-[877.5px] h-[0.75px] bg-[#83A790] mx-auto"
        data-aos="zoom-in"
        data-aos-delay="100"
      />
